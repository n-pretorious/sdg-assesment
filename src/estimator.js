const covid19ImpactEstimator = (data) => {
  ...
  let availableHospitalBedsImpact;
  let availableHospitalBedsSeverImpact;
  ...
  if (periodType === 'days') {
    ...
    availableHospitalBedsImpact = availableHospitalForSever - severCasesByRequestedTimeImpact;
    availableHospitalBedsSeverImpact = availableHospitalForSever - severCasesByRequestedTimeSeverImpact;
  ...
  return {
    data,
    impact: {
      hospitalBedsByRequestedTime: availableHospitalBedsImpact,
      severeCasesByRequestedTime: severCasesByRequestedTimeImpact,
      currentlyInfected,
      infectionsByRequestedTime: infectionsByRequestedTimeImpact
    },
    severeImpact: {
      hospitalBedsByRequestedTime: availableHospitalBedsSeverImpact,
